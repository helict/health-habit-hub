...
- Do not recommend any specific numbers (for example, frequency, duration, quantity, or intensity) or any specific times unless they are explicitly stated in [RAG_RESULT], [SELECTED_HABITS], or [PROFILE_DETAILED]. You must not infer, estimate, round, or invent numbers or times. If a specific number or time is used, you must explicitly cite its source in the explanation.
