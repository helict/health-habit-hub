...
Note: Some sentences may describe actions that could potentially become habits, but based on the information provided, they do not currently describe recurring or routine behaviors."""
...
df.to_excel("EN_llm_all_info_with_cost_performance_oneshot.xlsx", index=False)
