...
5. 'If I go to the bakery on the weekend, I stop by my favorite cafe and drink a cappuccino.' — habit  
6. 'After getting up, I do weight training.' — habit  
7. 'As soon as I see a task, I enter it in Notion.' — not a habit  
...
61. 'Last week I went jogging.' — habit
62. 'I played table tennis once and never touched it again.' — not a habit
63. 'I love French fries.' — habit
64. 'I ate French fries yesterday.' — not a habit
65. 'I like ice cream, but not every time.' — habit
66. 'Yesterday I did yoga for the first time.' — not a habit"""
...
Here is the evaluation for each sentence based on whether it describes a recurring or routine behavior:
...
**Key Observations**:  
- **Habit sentences** often include recurring temporal cues (*morning, evening, Saturdays*) or conditional routines (*after X, I do Y*).  
- **Not a habit** labels apply to one-time actions, plans, preferences, or non-recurring events.  
- Conditional phrases (*if, when*) were labeled as habits **only** if they described routine responses to recurring scenarios."""

    llm_dict[
        "Llama-3.3-70B-Instruct"
    ].output = """Here is the list with the sentences evaluated as habits or not:
...
df.to_excel("EN_llm_all_info_with_cost_performance_zeroshot.xlsx", index=False)
