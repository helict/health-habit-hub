...
66. 'Yesterday I did yoga for the first time.' — not a habit"""
    ...
    ].output = """Here is the list with the sentences evaluated as either "habit" or "not a habit":
...
Note that sentences 60 and 61 are similar, but sentence 60 describes a general behavior ("I go jogging"), which is a habit, while sentence 61 describes a specific instance ("Last week I went jogging"), which is not a habit."""
...
df.to_excel("EN_llm_all_info_with_cost_performance_with_definition.xlsx", index=False)
