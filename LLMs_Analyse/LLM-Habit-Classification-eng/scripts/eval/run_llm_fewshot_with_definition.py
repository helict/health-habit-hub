...
Note that sentences 60 and 61 could be considered habits if they were phrased as "I go jogging regularly" or "I go jogging every week", but as they are currently phrased, they are too vague to be classified as habits. Similarly, sentence 4 could be considered a habit, but it is not clear if it is a regular occurrence. However, based on the given context and the way the sentence is phrased, I have classified it as a habit."""
...
df.to_excel("EN_llm_all_info_with_cost_performance_fewshot_with_definition.xlsx", index=False)
